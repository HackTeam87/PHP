    ...
    <div class="container">
        <div class="row">
            ...
            <div class="6u 12u(mobile)">
                ...
                <!-- Banner Image -->
                <a href="#" class="bordered-feature-image"><img src="{{asset('assets/images/banner.jpg')}}" alt="" /></a>
        ...
        <div class="container">
            <div class="row">
                <div class="3u 12u(mobile)">
                    ...
                    <!-- Feature #1 -->
                    <section>
                        <a href="#" class="bordered-feature-image"><img src="{{asset('assets/images/pic01.jpg')}}" alt="" /></a>
                ...
                <div class="3u 12u(mobile)">
                    ...
                    <!-- Feature #2 -->
                    <section>
                        <a href="#" class="bordered-feature-image"><img src="{{asset('assets/images/pic02.jpg')}}" alt="" /></a>
                ...
                <div class="3u 12u(mobile)">
                    ...
                    <!-- Feature #3 -->
                    <section>
                        <a href="#" class="bordered-feature-image"><img src="{{asset('assets/images/pic03.jpg')}}" alt="" /></a>
                        <h2>License Info</h2>
                        <p>
                ...
                <div class="3u 12u(mobile)">
                    ...
                    <!-- Feature #4 -->
                    <section>
                        <a href="#" class="bordered-feature-image"><img src="{{asset('assets/images/pic04.jpg')}}" alt="" /></a>
            ...
            <div class="row">
                <div class="4u 12u(mobile)">
                    ...
                    <section>
                        ...
                        <a href="#" class="feature-image"><img src="{{asset('assets/images/pic05.jpg')}}" alt="" /></a>
                        <p>
                ...
                <div class="4u 12u(mobile)">
                    ...
                    <section>
                        ...
                        <ul class="quote-list">
                            <li>
                                <img src="{{asset('assets/images/pic06.jpg')}}" alt="" />
                                <p>"Neque nisidapibus mattis"</p>
                                <span>Jane Doe, CEO of UntitledCorp</span>
                            </li>
                            <li>
                                <img src="{{asset('assets/images/pic07.jpg')}}" alt="" />
                                <p>"Lorem ipsum consequat!"</p>
                                <span>John Doe, President of FakeBiz</span>
                            </li>
                            <li>
                                <img src="{{asset('assets/images/pic08.jpg')}}" alt="" />
